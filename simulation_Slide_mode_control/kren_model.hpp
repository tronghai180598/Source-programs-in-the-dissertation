...
protected:
public:
  float mTf=0;  /// Время интергирования от скорости до значения угла гиросокпа, и определяется его параметрами.
  float mTv=0;  /// Вhемя интергирования от приложеной силы на скорость, зависит от массы коптера и мощности двигателя
  float mTm=0;  /// время инреции частотного преобразователя двигателя 
